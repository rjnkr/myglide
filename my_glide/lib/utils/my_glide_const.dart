...
class MyGlideConst {
  ...
  static const String emailVeiligheidsManager  = "ict@gezc.org"; //"veiligheidsmanager@gezc.org";
  ...
  static const double noStallAltitude = 150;      // Onder de 150 meter mag snelheid niet onder takeOffSpeed komen, anders zijn we geland
  ...
  static const TextTheme myGlideTextTheme = TextTheme(
    ...
    body1      : TextStyle(debugLabel: 'blackCupertino body1',      fontFamily: '.SF UI Text',    inherit: true, color: Colors.black, decoration: TextDecoration.none),
