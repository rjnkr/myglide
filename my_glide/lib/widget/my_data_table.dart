...
class MyDataCell {
  ...
  static final MyDataCell empty = MyDataCell(Container(width: 0.0, height: 0.0));
...
class MyDataTable extends StatelessWidget {
  ...
  static const double _headingRowHeight = 40.0;
  ...
  Widget build(BuildContext context) {
    ...
    final bool allChecked = showCheckboxColumn && !rows.any((MyDataRow row) => row.onSelectChanged != null && !row.selected);
